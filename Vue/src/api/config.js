...
const API_newsBusiness = (data, fn) => { // 佣金概况
  let res = [{type:0,timer:'今天13:14',new:true,det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',new:true,det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426003'},{type:0,timer:'今天13:14',det:'张三丰面馆/三丰—联网报警服务费分期【¥3600.00/12期】已初审提交，等待终审！',order:'JXAN-0101180426004'}]
  fn(res)
}
const API_newsSys = (data, fn) => { // 佣金概况
  let res = [
    {
      title: '系统公告',
      timer: '今天13:14',
...
const API_newsAct = (data, fn) => { // 佣金概况
  let res = [{
    type: 0,
    title: '臻分期限时有奖推广',
    img: require('common/image/pc_img_banner01.png')
  }, {
    type: 1,
    title: '臻商贷限时优惠推广',
    img: require('common/image/pc_img_banner02.png')
  }]
  fn(res)
}
export {
